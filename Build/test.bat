...
REM Set nuget packages tool paths (packages.config use local packages folder)
...
REM Convert format
REM   - using PowerShell script to convert JUnit format test results to SonarQube Generic Format (for SonarQube)
